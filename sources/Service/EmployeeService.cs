...
{ 
    ...
    public async Task<IEnumerable<EmployeeDto>> GetAllEmployeesAsync(Guid companyId, bool trackChanges)
    {
        ...
        var employeesFromDb = await _repository.Employee.GetAllEmployeesAsync(companyId, trackChanges); 
    ...
    public async Task UpdateEmployeeForCompanyAsync(Guid companyId, Guid id, EmployeeForUpdateDto employeeForUpdate, bool compTrackChanges, bool empTrackChanges)
    {
        ...
        _mapper.Map(employeeForUpdate, employeeDb); await _repository.SaveAsync();
    }
